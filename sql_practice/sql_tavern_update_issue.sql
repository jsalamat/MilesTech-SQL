...
Insert Into GuestStatuses (Name) values ('ko');   --3
Insert Into GuestStatuses (Name) values ('confused');   --4
Insert Into GuestStatuses (Name) values ('face');   --5
Insert Into GuestStatuses (Name) values ('heel');   --6
Insert Into GuestStatuses (Name) values ('tweener');   --7
Insert Into GuestStatuses (Name) values ('jobber');   --8
Insert Into GuestStatuses (Name) values ('injured');   --9
Insert Into GuestStatuses (Name) values ('dazed');   --10

Insert Into Classes (Name) values ('mage');  --1
Insert Into Classes (Name) values ('fighter');  --2
Insert Into Classes (Name) values ('tank');  --3
Insert Into Classes (Name) values ('healer');  --4
Insert Into Classes (Name) values ('hero');  --5
Insert Into Classes (Name) values ('wrestler');  --6
Insert Into Classes (Name) values ('lucha libre');  --7
Insert Into Classes (Name) values ('strongstyle');  --8
Insert Into Classes (Name) values ('rapper');  --9

Insert Into Guests (Name, Birthday, Cakeday, StatusId, ClassId, level, Notes) values ('One Punchman', 'April 1, 2009', 'April 5, 2009', 1, 5 , 9999, 'A hero can defeat any opponent with a single punch'); 
Insert Into Guests (Name, Birthday, Cakeday, StatusId, ClassId, level, Notes) values ('Kenny Omega', 'October 16, 1983', 'October 21, 1983', 6, 6 , 99, 'The Bout Machine'); 
Insert Into Guests (Name, Birthday, Cakeday, StatusId, ClassId, level, Notes) values ('Tetsuya Naito', 'June 22, 1982', 'June 27, 1982', 7, 7 , 87, 'Tranquilo' ); 
Insert Into Guests (Name, Birthday, Cakeday, StatusId, ClassId, level, Notes) values ('Shinsuke Nakamura', 'February 24, 1980', 'February 29, 1980', 5, 8 , 100, 'King of Strong Style'); 
Insert Into Guests (Name, Birthday, Cakeday, StatusId, ClassId, level, Notes) values ('Snoop Dogg', 'October 20, 1971', 'October 25, 1971', 10, 9 , 420, 'Whats My Name?'); 
...
Select g.id,g.Name,g.Birthday, g.Cakeday, g.level,s.Name,c.Name,g.Notes
from Guests as g
inner join GuestStatuses as s on g.StatusId=s.Id
inner join Classes as c on g.ClassId=c.Id
...
/*
Select Guests.Name, Classes.Name, Guests.level
from Guests
inner join GuestStatuses on Guests.StatusId=GuestStatuses.Id
inner join Classes on Guests.ClassId=Classes.Id
...
-- 9. Write a series of INSERT commands that will insert the GuestStatuseses of one table into another of your choosing using SELECT statements (See our lab in class - The INSERT commands should be generated).
